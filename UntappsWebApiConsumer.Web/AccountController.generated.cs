...
namespace UntappdWebApiConsumer.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : UntappdWebApiConsumer.Web.Controllers.AccountController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, UntappdWebApiConsumer.Web.Models.LoginModel model, string returnUrl);

        [NonAction]
        public override System.Web.Mvc.ActionResult Login(UntappdWebApiConsumer.Web.Models.LoginModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        [NonAction]
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, UntappdWebApiConsumer.Web.Models.RegisterModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Register(UntappdWebApiConsumer.Web.Models.RegisterModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, UntappdWebApiConsumer.Web.Controllers.AccountController.ManageMessageId? message);

        [NonAction]
        public override System.Web.Mvc.ActionResult Manage(UntappdWebApiConsumer.Web.Controllers.AccountController.ManageMessageId? message)
        {
        ...
        [NonAction]
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, UntappdWebApiConsumer.Web.Models.LocalPasswordModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Manage(UntappdWebApiConsumer.Web.Models.LocalPasswordModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ExternalLoginConfirmationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, UntappdWebApiConsumer.Web.Models.RegisterExternalLoginModel model, string returnUrl);

        [NonAction]
        public override System.Web.Mvc.ActionResult ExternalLoginConfirmation(UntappdWebApiConsumer.Web.Models.RegisterExternalLoginModel model, string returnUrl)
        {
